/* Service Worker — Maus-tratos a Animais é Crime (versão adulta)
   Guarda o folder inteiro no aparelho no primeiro acesso com internet,
   para que os acessos seguintes funcionem mesmo offline.
   Para publicar uma atualização, troque a versão do CACHE (ex.: maus-tratos-adulto-v2). */

const CACHE = 'maus-tratos-adulto-v1';

/* Tudo que o folder precisa para abrir sem internet (fotos e dados dos gráficos estão embutidos no index.html).
